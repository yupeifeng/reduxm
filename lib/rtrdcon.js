...
var RtRdCon = function RtRdCon(mapStateToProps, mapDispatchToProps, ReactDom, pageName) {
	var ReactDomExt = function (_ReactDom) {
		_inherits(ReactDomExt, _ReactDom);

		function ReactDomExt() {
			_classCallCheck(this, ReactDomExt);

			return _possibleConstructorReturn(this, (ReactDomExt.__proto__ || Object.getPrototypeOf(ReactDomExt)).apply(this, arguments));
		}

		_createClass(ReactDomExt, [{
	...
	return (0, _reactRedux.connect)(mapStateToPropsExt, mapDispatchToPropsExt)(ReactDomExt);
};
