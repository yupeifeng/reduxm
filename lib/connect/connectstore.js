...
var ConnectStore = function ConnectStore() {
	var destroyStoreList = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	var storeList = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
			...
			return {
				sysRestState: (0, _redux.bindActionCreators)(function () {
					return function (dispatch) {
						destroyStoreList.forEach(function (item) {
