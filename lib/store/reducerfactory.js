...
var ReducerFactory = (_temp = _class = function () {
   ...
   */
		...
		value: function initReducer() {
			...
			this.initialData[storeName] = _immutable2.default.fromJS(initialData).toJS();
			this.excludeData[storeName] = _immutable2.default.fromJS(excludeData).toJS();
   ...
   */
		...
		value: function getAllInitData() {
			...
			var initialData = _immutable2.default.fromJS(this.initialData[storeName]).toJS();
			var excludeData = _immutable2.default.fromJS(this.excludeData[storeName]).toJS();
