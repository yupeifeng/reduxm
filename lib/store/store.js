				...
				actions[storeName + '_' + storePropsSign[key]] = function (state, action) {
					if (storeLogsSign[key]) {
						switch (storeLogsSign[key]) {
							case 'waring':
								console.warn('actionType:' + storePropsSign[key] + '  storeName:' + key + '  storeSource:' + JSON.stringify(action[key]));
								break;
							case 'log':
								console.log('actionType:' + storePropsSign[key] + '  storeName:' + key + '  storeSource:' + JSON.stringify(action[key]));
								break;
							case 'error':
								console.error('actionType:' + storePropsSign[key] + '  storeName:' + key + '  storeSource:' + JSON.stringify(action[key]));
								break;
							default:
								break;
						}
